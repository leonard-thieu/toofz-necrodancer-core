        ...
        Game ReadGame(XElement gameEl)
        {
            ...
            foreach (var gameAttr in gameEl.Attributes())
            {
                ...
                switch (gameAttrName)
                {
                    ...
                    case "askedLobbyMove": game.AskedLobbyMove = int.Parse(gameAttr.Value); break;
                    ...
                    case "bossTraining_banshee": game.BansheeBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_conga": game.CongaBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_deathmetal": game.DeathMetalBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_deepblues": game.DeepBluesBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_direbat": game.DireBatBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_dragon": game.DragonBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_fortissimole": game.FortissimoleBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_metrognome": game.MetrognomeBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_minotaur": game.MinotaurBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_nightmare": game.NightmareBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_octoboss": game.OctobossBossTraining = int.Parse(gameAttr.Value); break;
                    case "bossTraining_ogre": game.OgreBossTraining = int.Parse(gameAttr.Value); break;
                    case "charUnlocked0": game.Char0Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked1": game.Char1Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked10": game.Char10Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked11": game.Char11Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked12": game.Char12Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked13": game.Char13Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked14": game.Char14Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked2": game.Char2Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked3": game.Char3Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked4": game.Char4Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked5": game.Char5Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked6": game.Char6Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked7": game.Char7Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked8": game.Char8Unlocked = int.Parse(gameAttr.Value); break;
                    case "charUnlocked9": game.Char9Unlocked = int.Parse(gameAttr.Value); break;
                    case "currentLanguage": game.CurrentLanguage = gameAttr.Value; break;
                    case "daoustVocals": game.DaoustVocals = int.Parse(gameAttr.Value); break;
                    case "debugLoggingOn": game.DebugLoggingOn = int.Parse(gameAttr.Value); break;
                    ...
                    case "enableBossIntros": game.EnableBossIntros = int.Parse(gameAttr.Value); break;
                    case "enableCutscenes": game.EnableCutscenes = int.Parse(gameAttr.Value); break;
                    case "enableVsync": game.EnableVsync = int.Parse(gameAttr.Value); break;
                    case "foughtDeadRinger": game.FoughtDeadRinger = int.Parse(gameAttr.Value); break;
                    case "foughtNecrodancer": game.FoughtNecrodancer = int.Parse(gameAttr.Value); break;
                    case "foughtNecrodancer2": game.FoughtNecroDancer2 = int.Parse(gameAttr.Value); break;
                    case "fullscreen": game.Fullscreen = int.Parse(gameAttr.Value); break;
                    case "havePlayedHardcore": game.HavePlayedHardcore = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1003": game.HaveShownChangelogForVersion1003 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1004": game.HaveShownChangelogForVersion1004 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1005": game.HaveShownChangelogForVersion1005 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1008": game.HaveShownChangelogForVersion1008 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1009": game.HaveShownChangelogForVersion1009 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1019": game.HaveShownChangelogForVersion1019 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1020": game.HaveShownChangelogForVersion1020 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1021": game.HaveShownChangelogForVersion1021 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion1024": game.HaveShownChangelogForVersion1024 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2034": game.HaveShownChangelogForVersion2034 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2039": game.HaveShownChangelogForVersion2039 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2040": game.HaveShownChangelogForVersion2040 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2041": game.HaveShownChangelogForVersion2041 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2042": game.HaveShownChangelogForVersion2042 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2043": game.HaveShownChangelogForVersion2043 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2044": game.HaveShownChangelogForVersion2044 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2045": game.HaveShownChangelogForVersion2045 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2054": game.HaveShownChangelogForVersion2054 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion2055": game.HaveShownChangelogForVersion2055 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion370": game.HaveShownChangelogForVersion370 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion371": game.HaveShownChangelogForVersion371 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion373": game.HaveShownChangelogForVersion373 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion374": game.HaveShownChangelogForVersion374 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion375": game.HaveShownChangelogForVersion375 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion376": game.HaveShownChangelogForVersion376 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion377": game.HaveShownChangelogForVersion377 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion378": game.HaveShownChangelogForVersion378 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion379": game.HaveShownChangelogForVersion379 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion380": game.HaveShownChangelogForVersion380 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion381": game.HaveShownChangelogForVersion381 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion383": game.HaveShownChangelogForVersion383 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion384": game.HaveShownChangelogForVersion384 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion385": game.HaveShownChangelogForVersion385 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion386": game.HaveShownChangelogForVersion386 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion387": game.HaveShownChangelogForVersion387 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion388": game.HaveShownChangelogForVersion388 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion389": game.HaveShownChangelogForVersion389 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion390": game.HaveShownChangelogForVersion390 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion391": game.HaveShownChangelogForVersion391 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion392": game.HaveShownChangelogForVersion392 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion394": game.HaveShownChangelogForVersion394 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion399": game.HaveShownChangelogForVersion399 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion400": game.HaveShownChangelogForVersion400 = int.Parse(gameAttr.Value); break;
                    case "haveShownChangelogForVersion403": game.HaveShownChangelogForVersion403 = int.Parse(gameAttr.Value); break;
                    ...
                    case "killedEnemy_armadillo1": game.KilledArmadillo1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_armadillo2": game.KilledArmadillo2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_armadillo3": game.KilledArmadillo3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_armoredskeleton1": game.KilledArmoredSkeleton1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_armoredskeleton2": game.KilledArmoredSkeleton2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_armoredskeleton3": game.KilledArmoredSkeleton3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_banshee1": game.KilledBanshee1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_banshee2": game.KilledBanshee2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bat1": game.KilledBat1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bat2": game.KilledBat2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bat3": game.KilledBat3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bat4": game.KilledBat4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bat_miniboss1": game.KilledBatMiniboss1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bat_miniboss2": game.KilledBatMiniboss2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_beetle1": game.KilledBeetle1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_beetle2": game.KilledBeetle2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bishop1": game.KilledBishop1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bishop2": game.KilledBishop2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_blademaster1": game.KilledBlademaster1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_blademaster2": game.KilledBlademaster2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_bossmaster1": game.KilledBossmaster1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_cauldron1": game.KilledCauldron1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_clone1": game.KilledClone1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_conjurer1": game.KilledConjurer1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_coralriff1": game.KilledCoralRiff1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_crate1": game.KilledCrate1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_crate3": game.KilledCrate3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_deathmetal1": game.KilledDeathMetal1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_devil1": game.KilledDevil1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_devil2": game.KilledDevil2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_dragon1": game.KilledDragon1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_dragon2": game.KilledDragon2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_dragon3": game.KilledDragon3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_dragon4": game.KilledDragon4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_electric_mage1": game.KilledElectricMage1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_electric_mage2": game.KilledElectricMage2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_electric_mage3": game.KilledElectricMage3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_electric_orb1": game.KilledElectricOrb1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_evileye1": game.KilledEvilEye1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_evileye2": game.KilledEvilEye2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_fakewall1": game.KilledFakeWall1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_fakewall2": game.KilledFakeWall2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_fireelemental1": game.KilledFireElemental1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_fortissimole1": game.KilledFortissimole1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_gargoyle2": game.KilledGargoyle2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_ghast1": game.KilledGhast1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_ghost1": game.KilledGhost1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_ghoul1": game.KilledGhoul1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_goblin1": game.KilledGoblin1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_goblin2": game.KilledGoblin2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_goblin_bomber1": game.KilledGoblinBomber1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_golem1": game.KilledGolem1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_golem2": game.KilledGolem2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_golem3": game.KilledGolem3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_gorgon1": game.KilledGorgon1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_gorgon2": game.KilledGorgon2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_harpy1": game.KilledHarpy1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_hellhound1": game.KilledHellhound1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_iceelemental1": game.KilledIceElemental1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_king1": game.KilledKing1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_king2": game.KilledKing2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_king_conga1": game.KilledKingConga1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_knight1": game.KilledKnight1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_knight2": game.KilledKnight2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_leprechaun1": game.KilledLeprechaun1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_lich1": game.KilledLich1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_lich2": game.KilledLich2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_lich3": game.KilledLich3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_metrognome1": game.KilledMetrognome1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_metrognome2": game.KilledMetrognome2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_minotaur1": game.KilledMinotaur1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_minotaur2": game.KilledMinotaur2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_mole1": game.KilledMole1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_mommy1": game.KilledMommy1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_monkey1": game.KilledMonkey1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_monkey2": game.KilledMonkey2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_monkey3": game.KilledMonkey3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_monkey4": game.KilledMonkey4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_mummy1": game.KilledMummy1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_mushroom1": game.KilledMushroom1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_mushroom2": game.KilledMushroom2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_mushroom_light1": game.KilledMushroomLight1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_necrodancer1": game.KilledNecrodancer1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_nightmare1": game.KilledNightmare1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_nightmare2": game.KilledNightmare2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_ogre1": game.KilledOgre1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_orc1": game.KilledOrc1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_orc2": game.KilledOrc2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_orc3": game.KilledOrc3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_pawn1": game.KilledPawn1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_pawn2": game.KilledPawn2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_pixie1": game.KilledPixie1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_queen1": game.KilledQueen1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_queen2": game.KilledQueen2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_rook1": game.KilledRook1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_rook2": game.KilledRook2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_sarcophagus1": game.KilledSarcophagus1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_sarcophagus2": game.KilledSarcophagus2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_sarcophagus3": game.KilledSarcophagus3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shopkeeper1": game.KilledShopkeeper1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shopkeeper2": game.KilledShopkeeper2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shopkeeper3": game.KilledShopkeeper3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shopkeeper4": game.KilledShopkeeper4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shopkeeper5": game.KilledShopkeeper5 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shopkeeper_ghost1": game.KilledShopkeeperGhost1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shovemonster1": game.KilledShovemonster1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shovemonster2": game.KilledShovemonster2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_shriner1": game.KilledShriner1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeleton1": game.KilledSkeleton1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeleton2": game.KilledSkeleton2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeleton3": game.KilledSkeleton3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeletonknight1": game.KilledSkeletonKnight1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeletonknight2": game.KilledSkeletonKnight2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeletonknight3": game.KilledSkeletonKnight3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeletonmage1": game.KilledSkeletonMage1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeletonmage2": game.KilledSkeletonMage2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skeletonmage3": game.KilledSkeletonMage3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skull1": game.KilledSkull1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skull2": game.KilledSkull2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_skull3": game.KilledSkull3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_sleeping_goblin1": game.KilledSleepingGoblin1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_slime1": game.KilledSlime1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_slime2": game.KilledSlime2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_slime3": game.KilledSlime3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_slime4": game.KilledSlime4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_slime5": game.KilledSlime5 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_slime6": game.KilledSlime6 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_spider1": game.KilledSpider1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tarmonster1": game.KilledTarMonster1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle2": game.KilledTentacle2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle3": game.KilledTentacle3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle4": game.KilledTentacle4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle5": game.KilledTentacle5 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle6": game.KilledTentacle6 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle7": game.KilledTentacle7 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_tentacle8": game.KilledTentacle8 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_toughsarcophagus1": game.KilledToughSarcophagus1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_transmogrifier1": game.KilledTransmogrifier1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapcauldron1": game.KilledTrapCauldron1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapcauldron2": game.KilledTrapCauldron2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapchest1": game.KilledTrapChest1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapchest2": game.KilledTrapChest2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapchest3": game.KilledTrapChest3 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapchest4": game.KilledTrapChest4 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapchest5": game.KilledTrapChest5 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_trapchest6": game.KilledTrapChest6 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_warlock1": game.KilledWarlock1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_warlock2": game.KilledWarlock2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_water_ball1": game.KilledWaterBall1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_wight1": game.KilledWight1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_wraith1": game.KilledWraith1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_wraith2": game.KilledWraith2 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_yeti1": game.KilledYeti1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_zombie1": game.KilledZombie1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_zombie_electric1": game.KilledZombieElectric1 = int.Parse(gameAttr.Value); break;
                    case "killedEnemy_zombie_snake1": game.KilledZombieSnake1 = int.Parse(gameAttr.Value); break;
                    case "latencyCalibrated": game.LatencyCalibrated = bool.Parse(gameAttr.Value); break;
                    case "lobbyMove": game.LobbyMove = int.Parse(gameAttr.Value); break;
                    case "mentorLevelClear0": game.MentorLevelClear0 = int.Parse(gameAttr.Value); break;
                    case "mentorLevelClear1": game.MentorLevelClear1 = int.Parse(gameAttr.Value); break;
                    case "mentorLevelClear2": game.MentorLevelClear2 = int.Parse(gameAttr.Value); break;
                    case "mentorLevelClear3": game.MentorLevelClear3 = int.Parse(gameAttr.Value); break;
                    ...
                    case "preBossEffect": game.PreBossEffect = int.Parse(gameAttr.Value); break;
                    case "resolutionH": game.ResolutionH = int.Parse(gameAttr.Value); break;
                    case "resolutionW": game.ResolutionW = int.Parse(gameAttr.Value); break;
                    case "screenShake": game.ScreenShake = int.Parse(gameAttr.Value); break;
                    case "showDiscoFloor": game.ShowDiscoFloor = int.Parse(gameAttr.Value); break;
                    case "showHUDBeatBars": game.ShowHudBeatBars = int.Parse(gameAttr.Value); break;
                    case "showHUDHeart": game.ShowHudHeart = int.Parse(gameAttr.Value); break;
                    case "showHints": game.ShowHints = int.Parse(gameAttr.Value); break;
                    case "showSpeedrunTimer": game.ShowSpeedRunTimer = int.Parse(gameAttr.Value); break;
                    case "shownNocturnaIntro": game.ShownNocturnaIntro = int.Parse(gameAttr.Value); break;
                    case "shownSeizureWarning": game.ShownSeizureWarning = int.Parse(gameAttr.Value); break;
                    ...
                    case "useChoral": game.UseChoral = int.Parse(gameAttr.Value); break;
