...
namespace toofz.NecroDancer.Saves
{
    sealed class SaveDataWriter
    {
        ...
        static XElement WriteGame(Game game)
        {
            ...
            if (game._AskedLobbyMove != null) { gameEl.Add(new XAttribute("askedLobbyMove", game.AskedLobbyMove)); }
            ...
            if (game._BansheeBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_banshee", game.BansheeBossTraining)); }
            if (game._CongaBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_conga", game.CongaBossTraining)); }
            if (game._DeathMetalBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_deathmetal", game.DeathMetalBossTraining)); }
            if (game._DeepBluesBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_deepblues", game.DeepBluesBossTraining)); }
            if (game._DireBatBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_direbat", game.DireBatBossTraining)); }
            if (game._DragonBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_dragon", game.DragonBossTraining)); }
            if (game._FortissimoleBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_fortissimole", game.FortissimoleBossTraining)); }
            if (game._MetrognomeBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_metrognome", game.MetrognomeBossTraining)); }
            if (game._MinotaurBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_minotaur", game.MinotaurBossTraining)); }
            if (game._NightmareBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_nightmare", game.NightmareBossTraining)); }
            if (game._OctobossBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_octoboss", game.OctobossBossTraining)); }
            if (game._OgreBossTraining != null) { gameEl.Add(new XAttribute("bossTraining_ogre", game.OgreBossTraining)); }
            if (game._Char0Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked0", game.Char0Unlocked)); }
            if (game._Char1Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked1", game.Char1Unlocked)); }
            if (game._Char10Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked10", game.Char10Unlocked)); }
            if (game._Char11Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked11", game.Char11Unlocked)); }
            if (game._Char12Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked12", game.Char12Unlocked)); }
            if (game._Char13Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked13", game.Char13Unlocked)); }
            if (game._Char14Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked14", game.Char14Unlocked)); }
            if (game._Char2Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked2", game.Char2Unlocked)); }
            if (game._Char3Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked3", game.Char3Unlocked)); }
            if (game._Char4Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked4", game.Char4Unlocked)); }
            if (game._Char5Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked5", game.Char5Unlocked)); }
            if (game._Char6Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked6", game.Char6Unlocked)); }
            if (game._Char7Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked7", game.Char7Unlocked)); }
            if (game._Char8Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked8", game.Char8Unlocked)); }
            if (game._Char9Unlocked != null) { gameEl.Add(new XAttribute("charUnlocked9", game.Char9Unlocked)); }
            if (game.CurrentLanguage != null) { gameEl.Add(new XAttribute("currentLanguage", game.CurrentLanguage)); }
            if (game._DaoustVocals != null) { gameEl.Add(new XAttribute("daoustVocals", game.DaoustVocals)); }
            if (game._DebugLoggingOn != null) { gameEl.Add(new XAttribute("debugLoggingOn", game.DebugLoggingOn)); }
            ...
            if (game._EnableBossIntros != null) { gameEl.Add(new XAttribute("enableBossIntros", game.EnableBossIntros)); }
            if (game._EnableCutscenes != null) { gameEl.Add(new XAttribute("enableCutscenes", game.EnableCutscenes)); }
            if (game._EnableVsync != null) { gameEl.Add(new XAttribute("enableVsync", game.EnableVsync)); }
            if (game._FoughtDeadRinger != null) { gameEl.Add(new XAttribute("foughtDeadRinger", game.FoughtDeadRinger)); }
            if (game._FoughtNecrodancer != null) { gameEl.Add(new XAttribute("foughtNecrodancer", game.FoughtNecrodancer)); }
            if (game._FoughtNecroDancer2 != null) { gameEl.Add(new XAttribute("foughtNecrodancer2", game.FoughtNecroDancer2)); }
            if (game._Fullscreen != null) { gameEl.Add(new XAttribute("fullscreen", game.Fullscreen)); }
            if (game._HavePlayedHardcore != null) { gameEl.Add(new XAttribute("havePlayedHardcore", game.HavePlayedHardcore)); }
            if (game._HaveShownChangelogForVersion1003 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1003", game.HaveShownChangelogForVersion1003)); }
            if (game._HaveShownChangelogForVersion1004 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1004", game.HaveShownChangelogForVersion1004)); }
            if (game._HaveShownChangelogForVersion1005 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1005", game.HaveShownChangelogForVersion1005)); }
            if (game._HaveShownChangelogForVersion1008 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1008", game.HaveShownChangelogForVersion1008)); }
            if (game._HaveShownChangelogForVersion1009 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1009", game.HaveShownChangelogForVersion1009)); }
            if (game._HaveShownChangelogForVersion1019 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1019", game.HaveShownChangelogForVersion1019)); }
            if (game._HaveShownChangelogForVersion1020 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1020", game.HaveShownChangelogForVersion1020)); }
            if (game._HaveShownChangelogForVersion1021 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1021", game.HaveShownChangelogForVersion1021)); }
            if (game._HaveShownChangelogForVersion1024 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion1024", game.HaveShownChangelogForVersion1024)); }
            if (game._HaveShownChangelogForVersion2034 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2034", game.HaveShownChangelogForVersion2034)); }
            if (game._HaveShownChangelogForVersion2039 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2039", game.HaveShownChangelogForVersion2039)); }
            if (game._HaveShownChangelogForVersion2040 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2040", game.HaveShownChangelogForVersion2040)); }
            if (game._HaveShownChangelogForVersion2041 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2041", game.HaveShownChangelogForVersion2041)); }
            if (game._HaveShownChangelogForVersion2042 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2042", game.HaveShownChangelogForVersion2042)); }
            if (game._HaveShownChangelogForVersion2043 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2043", game.HaveShownChangelogForVersion2043)); }
            if (game._HaveShownChangelogForVersion2044 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2044", game.HaveShownChangelogForVersion2044)); }
            if (game._HaveShownChangelogForVersion2045 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2045", game.HaveShownChangelogForVersion2045)); }
            if (game._HaveShownChangelogForVersion2054 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2054", game.HaveShownChangelogForVersion2054)); }
            if (game._HaveShownChangelogForVersion2055 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion2055", game.HaveShownChangelogForVersion2055)); }
            if (game._HaveShownChangelogForVersion370 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion370", game.HaveShownChangelogForVersion370)); }
            if (game._HaveShownChangelogForVersion371 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion371", game.HaveShownChangelogForVersion371)); }
            if (game._HaveShownChangelogForVersion373 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion373", game.HaveShownChangelogForVersion373)); }
            if (game._HaveShownChangelogForVersion374 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion374", game.HaveShownChangelogForVersion374)); }
            if (game._HaveShownChangelogForVersion375 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion375", game.HaveShownChangelogForVersion375)); }
            if (game._HaveShownChangelogForVersion376 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion376", game.HaveShownChangelogForVersion376)); }
            if (game._HaveShownChangelogForVersion377 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion377", game.HaveShownChangelogForVersion377)); }
            if (game._HaveShownChangelogForVersion378 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion378", game.HaveShownChangelogForVersion378)); }
            if (game._HaveShownChangelogForVersion379 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion379", game.HaveShownChangelogForVersion379)); }
            if (game._HaveShownChangelogForVersion380 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion380", game.HaveShownChangelogForVersion380)); }
            if (game._HaveShownChangelogForVersion381 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion381", game.HaveShownChangelogForVersion381)); }
            if (game._HaveShownChangelogForVersion383 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion383", game.HaveShownChangelogForVersion383)); }
            if (game._HaveShownChangelogForVersion384 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion384", game.HaveShownChangelogForVersion384)); }
            if (game._HaveShownChangelogForVersion385 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion385", game.HaveShownChangelogForVersion385)); }
            if (game._HaveShownChangelogForVersion386 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion386", game.HaveShownChangelogForVersion386)); }
            if (game._HaveShownChangelogForVersion387 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion387", game.HaveShownChangelogForVersion387)); }
            if (game._HaveShownChangelogForVersion388 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion388", game.HaveShownChangelogForVersion388)); }
            if (game._HaveShownChangelogForVersion389 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion389", game.HaveShownChangelogForVersion389)); }
            if (game._HaveShownChangelogForVersion390 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion390", game.HaveShownChangelogForVersion390)); }
            if (game._HaveShownChangelogForVersion391 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion391", game.HaveShownChangelogForVersion391)); }
            if (game._HaveShownChangelogForVersion392 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion392", game.HaveShownChangelogForVersion392)); }
            if (game._HaveShownChangelogForVersion394 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion394", game.HaveShownChangelogForVersion394)); }
            if (game._HaveShownChangelogForVersion399 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion399", game.HaveShownChangelogForVersion399)); }
            if (game._HaveShownChangelogForVersion400 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion400", game.HaveShownChangelogForVersion400)); }
            if (game._HaveShownChangelogForVersion403 != null) { gameEl.Add(new XAttribute("haveShownChangelogForVersion403", game.HaveShownChangelogForVersion403)); }
            ...
            if (game._KilledArmadillo1 != null) { gameEl.Add(new XAttribute("killedEnemy_armadillo1", game.KilledArmadillo1)); }
            if (game._KilledArmadillo2 != null) { gameEl.Add(new XAttribute("killedEnemy_armadillo2", game.KilledArmadillo2)); }
            if (game._KilledArmadillo3 != null) { gameEl.Add(new XAttribute("killedEnemy_armadillo3", game.KilledArmadillo3)); }
            if (game._KilledArmoredSkeleton1 != null) { gameEl.Add(new XAttribute("killedEnemy_armoredskeleton1", game.KilledArmoredSkeleton1)); }
            if (game._KilledArmoredSkeleton2 != null) { gameEl.Add(new XAttribute("killedEnemy_armoredskeleton2", game.KilledArmoredSkeleton2)); }
            if (game._KilledArmoredSkeleton3 != null) { gameEl.Add(new XAttribute("killedEnemy_armoredskeleton3", game.KilledArmoredSkeleton3)); }
            if (game._KilledBanshee1 != null) { gameEl.Add(new XAttribute("killedEnemy_banshee1", game.KilledBanshee1)); }
            if (game._KilledBanshee2 != null) { gameEl.Add(new XAttribute("killedEnemy_banshee2", game.KilledBanshee2)); }
            if (game._KilledBat1 != null) { gameEl.Add(new XAttribute("killedEnemy_bat1", game.KilledBat1)); }
            if (game._KilledBat2 != null) { gameEl.Add(new XAttribute("killedEnemy_bat2", game.KilledBat2)); }
            if (game._KilledBat3 != null) { gameEl.Add(new XAttribute("killedEnemy_bat3", game.KilledBat3)); }
            if (game._KilledBat4 != null) { gameEl.Add(new XAttribute("killedEnemy_bat4", game.KilledBat4)); }
            if (game._KilledBatMiniboss1 != null) { gameEl.Add(new XAttribute("killedEnemy_bat_miniboss1", game.KilledBatMiniboss1)); }
            if (game._KilledBatMiniboss2 != null) { gameEl.Add(new XAttribute("killedEnemy_bat_miniboss2", game.KilledBatMiniboss2)); }
            if (game._KilledBeetle1 != null) { gameEl.Add(new XAttribute("killedEnemy_beetle1", game.KilledBeetle1)); }
            if (game._KilledBeetle2 != null) { gameEl.Add(new XAttribute("killedEnemy_beetle2", game.KilledBeetle2)); }
            if (game._KilledBishop1 != null) { gameEl.Add(new XAttribute("killedEnemy_bishop1", game.KilledBishop1)); }
            if (game._KilledBishop2 != null) { gameEl.Add(new XAttribute("killedEnemy_bishop2", game.KilledBishop2)); }
            if (game._KilledBlademaster1 != null) { gameEl.Add(new XAttribute("killedEnemy_blademaster1", game.KilledBlademaster1)); }
            if (game._KilledBlademaster2 != null) { gameEl.Add(new XAttribute("killedEnemy_blademaster2", game.KilledBlademaster2)); }
            if (game._KilledBossmaster1 != null) { gameEl.Add(new XAttribute("killedEnemy_bossmaster1", game.KilledBossmaster1)); }
            if (game._KilledCauldron1 != null) { gameEl.Add(new XAttribute("killedEnemy_cauldron1", game.KilledCauldron1)); }
            if (game._KilledClone1 != null) { gameEl.Add(new XAttribute("killedEnemy_clone1", game.KilledClone1)); }
            if (game._KilledConjurer1 != null) { gameEl.Add(new XAttribute("killedEnemy_conjurer1", game.KilledConjurer1)); }
            if (game._KilledCoralRiff1 != null) { gameEl.Add(new XAttribute("killedEnemy_coralriff1", game.KilledCoralRiff1)); }
            if (game._KilledCrate1 != null) { gameEl.Add(new XAttribute("killedEnemy_crate1", game.KilledCrate1)); }
            if (game._KilledCrate3 != null) { gameEl.Add(new XAttribute("killedEnemy_crate3", game.KilledCrate3)); }
            if (game._KilledDeathMetal1 != null) { gameEl.Add(new XAttribute("killedEnemy_deathmetal1", game.KilledDeathMetal1)); }
            if (game._KilledDevil1 != null) { gameEl.Add(new XAttribute("killedEnemy_devil1", game.KilledDevil1)); }
            if (game._KilledDevil2 != null) { gameEl.Add(new XAttribute("killedEnemy_devil2", game.KilledDevil2)); }
            if (game._KilledDragon1 != null) { gameEl.Add(new XAttribute("killedEnemy_dragon1", game.KilledDragon1)); }
            if (game._KilledDragon2 != null) { gameEl.Add(new XAttribute("killedEnemy_dragon2", game.KilledDragon2)); }
            if (game._KilledDragon3 != null) { gameEl.Add(new XAttribute("killedEnemy_dragon3", game.KilledDragon3)); }
            if (game._KilledDragon4 != null) { gameEl.Add(new XAttribute("killedEnemy_dragon4", game.KilledDragon4)); }
            if (game._KilledElectricMage1 != null) { gameEl.Add(new XAttribute("killedEnemy_electric_mage1", game.KilledElectricMage1)); }
            if (game._KilledElectricMage2 != null) { gameEl.Add(new XAttribute("killedEnemy_electric_mage2", game.KilledElectricMage2)); }
            if (game._KilledElectricMage3 != null) { gameEl.Add(new XAttribute("killedEnemy_electric_mage3", game.KilledElectricMage3)); }
            if (game._KilledElectricOrb1 != null) { gameEl.Add(new XAttribute("killedEnemy_electric_orb1", game.KilledElectricOrb1)); }
            if (game._KilledEvilEye1 != null) { gameEl.Add(new XAttribute("killedEnemy_evileye1", game.KilledEvilEye1)); }
            if (game._KilledEvilEye2 != null) { gameEl.Add(new XAttribute("killedEnemy_evileye2", game.KilledEvilEye2)); }
            if (game._KilledFakeWall1 != null) { gameEl.Add(new XAttribute("killedEnemy_fakewall1", game.KilledFakeWall1)); }
            if (game._KilledFakeWall2 != null) { gameEl.Add(new XAttribute("killedEnemy_fakewall2", game.KilledFakeWall2)); }
            if (game._KilledFireElemental1 != null) { gameEl.Add(new XAttribute("killedEnemy_fireelemental1", game.KilledFireElemental1)); }
            if (game._KilledFortissimole1 != null) { gameEl.Add(new XAttribute("killedEnemy_fortissimole1", game.KilledFortissimole1)); }
            if (game._KilledGargoyle2 != null) { gameEl.Add(new XAttribute("killedEnemy_gargoyle2", game.KilledGargoyle2)); }
            if (game._KilledGhast1 != null) { gameEl.Add(new XAttribute("killedEnemy_ghast1", game.KilledGhast1)); }
            if (game._KilledGhost1 != null) { gameEl.Add(new XAttribute("killedEnemy_ghost1", game.KilledGhost1)); }
            if (game._KilledGhoul1 != null) { gameEl.Add(new XAttribute("killedEnemy_ghoul1", game.KilledGhoul1)); }
            if (game._KilledGoblin1 != null) { gameEl.Add(new XAttribute("killedEnemy_goblin1", game.KilledGoblin1)); }
            if (game._KilledGoblin2 != null) { gameEl.Add(new XAttribute("killedEnemy_goblin2", game.KilledGoblin2)); }
            if (game._KilledGoblinBomber1 != null) { gameEl.Add(new XAttribute("killedEnemy_goblin_bomber1", game.KilledGoblinBomber1)); }
            if (game._KilledGolem1 != null) { gameEl.Add(new XAttribute("killedEnemy_golem1", game.KilledGolem1)); }
            if (game._KilledGolem2 != null) { gameEl.Add(new XAttribute("killedEnemy_golem2", game.KilledGolem2)); }
            if (game._KilledGolem3 != null) { gameEl.Add(new XAttribute("killedEnemy_golem3", game.KilledGolem3)); }
            if (game._KilledGorgon1 != null) { gameEl.Add(new XAttribute("killedEnemy_gorgon1", game.KilledGorgon1)); }
            if (game._KilledGorgon2 != null) { gameEl.Add(new XAttribute("killedEnemy_gorgon2", game.KilledGorgon2)); }
            if (game._KilledHarpy1 != null) { gameEl.Add(new XAttribute("killedEnemy_harpy1", game.KilledHarpy1)); }
            if (game._KilledHellhound1 != null) { gameEl.Add(new XAttribute("killedEnemy_hellhound1", game.KilledHellhound1)); }
            if (game._KilledIceElemental1 != null) { gameEl.Add(new XAttribute("killedEnemy_iceelemental1", game.KilledIceElemental1)); }
            if (game._KilledKing1 != null) { gameEl.Add(new XAttribute("killedEnemy_king1", game.KilledKing1)); }
            if (game._KilledKing2 != null) { gameEl.Add(new XAttribute("killedEnemy_king2", game.KilledKing2)); }
            if (game._KilledKingConga1 != null) { gameEl.Add(new XAttribute("killedEnemy_king_conga1", game.KilledKingConga1)); }
            if (game._KilledKnight1 != null) { gameEl.Add(new XAttribute("killedEnemy_knight1", game.KilledKnight1)); }
            if (game._KilledKnight2 != null) { gameEl.Add(new XAttribute("killedEnemy_knight2", game.KilledKnight2)); }
            if (game._KilledLeprechaun1 != null) { gameEl.Add(new XAttribute("killedEnemy_leprechaun1", game.KilledLeprechaun1)); }
            if (game._KilledLich1 != null) { gameEl.Add(new XAttribute("killedEnemy_lich1", game.KilledLich1)); }
            if (game._KilledLich2 != null) { gameEl.Add(new XAttribute("killedEnemy_lich2", game.KilledLich2)); }
            if (game._KilledLich3 != null) { gameEl.Add(new XAttribute("killedEnemy_lich3", game.KilledLich3)); }
            if (game._KilledMetrognome1 != null) { gameEl.Add(new XAttribute("killedEnemy_metrognome1", game.KilledMetrognome1)); }
            if (game._KilledMetrognome2 != null) { gameEl.Add(new XAttribute("killedEnemy_metrognome2", game.KilledMetrognome2)); }
            if (game._KilledMinotaur1 != null) { gameEl.Add(new XAttribute("killedEnemy_minotaur1", game.KilledMinotaur1)); }
            if (game._KilledMinotaur2 != null) { gameEl.Add(new XAttribute("killedEnemy_minotaur2", game.KilledMinotaur2)); }
            if (game._KilledMole1 != null) { gameEl.Add(new XAttribute("killedEnemy_mole1", game.KilledMole1)); }
            if (game._KilledMommy1 != null) { gameEl.Add(new XAttribute("killedEnemy_mommy1", game.KilledMommy1)); }
            if (game._KilledMonkey1 != null) { gameEl.Add(new XAttribute("killedEnemy_monkey1", game.KilledMonkey1)); }
            if (game._KilledMonkey2 != null) { gameEl.Add(new XAttribute("killedEnemy_monkey2", game.KilledMonkey2)); }
            if (game._KilledMonkey3 != null) { gameEl.Add(new XAttribute("killedEnemy_monkey3", game.KilledMonkey3)); }
            if (game._KilledMonkey4 != null) { gameEl.Add(new XAttribute("killedEnemy_monkey4", game.KilledMonkey4)); }
            if (game._KilledMummy1 != null) { gameEl.Add(new XAttribute("killedEnemy_mummy1", game.KilledMummy1)); }
            if (game._KilledMushroom1 != null) { gameEl.Add(new XAttribute("killedEnemy_mushroom1", game.KilledMushroom1)); }
            if (game._KilledMushroom2 != null) { gameEl.Add(new XAttribute("killedEnemy_mushroom2", game.KilledMushroom2)); }
            if (game._KilledMushroomLight1 != null) { gameEl.Add(new XAttribute("killedEnemy_mushroom_light1", game.KilledMushroomLight1)); }
            if (game._KilledNecrodancer1 != null) { gameEl.Add(new XAttribute("killedEnemy_necrodancer1", game.KilledNecrodancer1)); }
            if (game._KilledNightmare1 != null) { gameEl.Add(new XAttribute("killedEnemy_nightmare1", game.KilledNightmare1)); }
            if (game._KilledNightmare2 != null) { gameEl.Add(new XAttribute("killedEnemy_nightmare2", game.KilledNightmare2)); }
            if (game._KilledOgre1 != null) { gameEl.Add(new XAttribute("killedEnemy_ogre1", game.KilledOgre1)); }
            if (game._KilledOrc1 != null) { gameEl.Add(new XAttribute("killedEnemy_orc1", game.KilledOrc1)); }
            if (game._KilledOrc2 != null) { gameEl.Add(new XAttribute("killedEnemy_orc2", game.KilledOrc2)); }
            if (game._KilledOrc3 != null) { gameEl.Add(new XAttribute("killedEnemy_orc3", game.KilledOrc3)); }
            if (game._KilledPawn1 != null) { gameEl.Add(new XAttribute("killedEnemy_pawn1", game.KilledPawn1)); }
            if (game._KilledPawn2 != null) { gameEl.Add(new XAttribute("killedEnemy_pawn2", game.KilledPawn2)); }
            if (game._KilledPixie1 != null) { gameEl.Add(new XAttribute("killedEnemy_pixie1", game.KilledPixie1)); }
            if (game._KilledQueen1 != null) { gameEl.Add(new XAttribute("killedEnemy_queen1", game.KilledQueen1)); }
            if (game._KilledQueen2 != null) { gameEl.Add(new XAttribute("killedEnemy_queen2", game.KilledQueen2)); }
            if (game._KilledRook1 != null) { gameEl.Add(new XAttribute("killedEnemy_rook1", game.KilledRook1)); }
            if (game._KilledRook2 != null) { gameEl.Add(new XAttribute("killedEnemy_rook2", game.KilledRook2)); }
            if (game._KilledSarcophagus1 != null) { gameEl.Add(new XAttribute("killedEnemy_sarcophagus1", game.KilledSarcophagus1)); }
            if (game._KilledSarcophagus2 != null) { gameEl.Add(new XAttribute("killedEnemy_sarcophagus2", game.KilledSarcophagus2)); }
            if (game._KilledSarcophagus3 != null) { gameEl.Add(new XAttribute("killedEnemy_sarcophagus3", game.KilledSarcophagus3)); }
            if (game._KilledShopkeeper1 != null) { gameEl.Add(new XAttribute("killedEnemy_shopkeeper1", game.KilledShopkeeper1)); }
            if (game._KilledShopkeeper2 != null) { gameEl.Add(new XAttribute("killedEnemy_shopkeeper2", game.KilledShopkeeper2)); }
            if (game._KilledShopkeeper3 != null) { gameEl.Add(new XAttribute("killedEnemy_shopkeeper3", game.KilledShopkeeper3)); }
            if (game._KilledShopkeeper4 != null) { gameEl.Add(new XAttribute("killedEnemy_shopkeeper4", game.KilledShopkeeper4)); }
            if (game._KilledShopkeeper5 != null) { gameEl.Add(new XAttribute("killedEnemy_shopkeeper5", game.KilledShopkeeper5)); }
            if (game._KilledShopkeeperGhost1 != null) { gameEl.Add(new XAttribute("killedEnemy_shopkeeper_ghost1", game.KilledShopkeeperGhost1)); }
            if (game._KilledShovemonster1 != null) { gameEl.Add(new XAttribute("killedEnemy_shovemonster1", game.KilledShovemonster1)); }
            if (game._KilledShovemonster2 != null) { gameEl.Add(new XAttribute("killedEnemy_shovemonster2", game.KilledShovemonster2)); }
            if (game._KilledShriner1 != null) { gameEl.Add(new XAttribute("killedEnemy_shriner1", game.KilledShriner1)); }
            if (game._KilledSkeleton1 != null) { gameEl.Add(new XAttribute("killedEnemy_skeleton1", game.KilledSkeleton1)); }
            if (game._KilledSkeleton2 != null) { gameEl.Add(new XAttribute("killedEnemy_skeleton2", game.KilledSkeleton2)); }
            if (game._KilledSkeleton3 != null) { gameEl.Add(new XAttribute("killedEnemy_skeleton3", game.KilledSkeleton3)); }
            if (game._KilledSkeletonKnight1 != null) { gameEl.Add(new XAttribute("killedEnemy_skeletonknight1", game.KilledSkeletonKnight1)); }
            if (game._KilledSkeletonKnight2 != null) { gameEl.Add(new XAttribute("killedEnemy_skeletonknight2", game.KilledSkeletonKnight2)); }
            if (game._KilledSkeletonKnight3 != null) { gameEl.Add(new XAttribute("killedEnemy_skeletonknight3", game.KilledSkeletonKnight3)); }
            if (game._KilledSkeletonMage1 != null) { gameEl.Add(new XAttribute("killedEnemy_skeletonmage1", game.KilledSkeletonMage1)); }
            if (game._KilledSkeletonMage2 != null) { gameEl.Add(new XAttribute("killedEnemy_skeletonmage2", game.KilledSkeletonMage2)); }
            if (game._KilledSkeletonMage3 != null) { gameEl.Add(new XAttribute("killedEnemy_skeletonmage3", game.KilledSkeletonMage3)); }
            if (game._KilledSkull1 != null) { gameEl.Add(new XAttribute("killedEnemy_skull1", game.KilledSkull1)); }
            if (game._KilledSkull2 != null) { gameEl.Add(new XAttribute("killedEnemy_skull2", game.KilledSkull2)); }
            if (game._KilledSkull3 != null) { gameEl.Add(new XAttribute("killedEnemy_skull3", game.KilledSkull3)); }
            if (game._KilledSleepingGoblin1 != null) { gameEl.Add(new XAttribute("killedEnemy_sleeping_goblin1", game.KilledSleepingGoblin1)); }
            if (game._KilledSlime1 != null) { gameEl.Add(new XAttribute("killedEnemy_slime1", game.KilledSlime1)); }
            if (game._KilledSlime2 != null) { gameEl.Add(new XAttribute("killedEnemy_slime2", game.KilledSlime2)); }
            if (game._KilledSlime3 != null) { gameEl.Add(new XAttribute("killedEnemy_slime3", game.KilledSlime3)); }
            if (game._KilledSlime4 != null) { gameEl.Add(new XAttribute("killedEnemy_slime4", game.KilledSlime4)); }
            if (game._KilledSlime5 != null) { gameEl.Add(new XAttribute("killedEnemy_slime5", game.KilledSlime5)); }
            if (game._KilledSlime6 != null) { gameEl.Add(new XAttribute("killedEnemy_slime6", game.KilledSlime6)); }
            if (game._KilledSpider1 != null) { gameEl.Add(new XAttribute("killedEnemy_spider1", game.KilledSpider1)); }
            if (game._KilledTarMonster1 != null) { gameEl.Add(new XAttribute("killedEnemy_tarmonster1", game.KilledTarMonster1)); }
            if (game._KilledTentacle2 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle2", game.KilledTentacle2)); }
            if (game._KilledTentacle3 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle3", game.KilledTentacle3)); }
            if (game._KilledTentacle4 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle4", game.KilledTentacle4)); }
            if (game._KilledTentacle5 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle5", game.KilledTentacle5)); }
            if (game._KilledTentacle6 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle6", game.KilledTentacle6)); }
            if (game._KilledTentacle7 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle7", game.KilledTentacle7)); }
            if (game._KilledTentacle8 != null) { gameEl.Add(new XAttribute("killedEnemy_tentacle8", game.KilledTentacle8)); }
            if (game._KilledToughSarcophagus1 != null) { gameEl.Add(new XAttribute("killedEnemy_toughsarcophagus1", game.KilledToughSarcophagus1)); }
            if (game._KilledTransmogrifier1 != null) { gameEl.Add(new XAttribute("killedEnemy_transmogrifier1", game.KilledTransmogrifier1)); }
            if (game._KilledTrapCauldron1 != null) { gameEl.Add(new XAttribute("killedEnemy_trapcauldron1", game.KilledTrapCauldron1)); }
            if (game._KilledTrapCauldron2 != null) { gameEl.Add(new XAttribute("killedEnemy_trapcauldron2", game.KilledTrapCauldron2)); }
            if (game._KilledTrapChest1 != null) { gameEl.Add(new XAttribute("killedEnemy_trapchest1", game.KilledTrapChest1)); }
            if (game._KilledTrapChest2 != null) { gameEl.Add(new XAttribute("killedEnemy_trapchest2", game.KilledTrapChest2)); }
            if (game._KilledTrapChest3 != null) { gameEl.Add(new XAttribute("killedEnemy_trapchest3", game.KilledTrapChest3)); }
            if (game._KilledTrapChest4 != null) { gameEl.Add(new XAttribute("killedEnemy_trapchest4", game.KilledTrapChest4)); }
            if (game._KilledTrapChest5 != null) { gameEl.Add(new XAttribute("killedEnemy_trapchest5", game.KilledTrapChest5)); }
            if (game._KilledTrapChest6 != null) { gameEl.Add(new XAttribute("killedEnemy_trapchest6", game.KilledTrapChest6)); }
            if (game._KilledWarlock1 != null) { gameEl.Add(new XAttribute("killedEnemy_warlock1", game.KilledWarlock1)); }
            if (game._KilledWarlock2 != null) { gameEl.Add(new XAttribute("killedEnemy_warlock2", game.KilledWarlock2)); }
            if (game._KilledWaterBall1 != null) { gameEl.Add(new XAttribute("killedEnemy_water_ball1", game.KilledWaterBall1)); }
            if (game._KilledWight1 != null) { gameEl.Add(new XAttribute("killedEnemy_wight1", game.KilledWight1)); }
            if (game._KilledWraith1 != null) { gameEl.Add(new XAttribute("killedEnemy_wraith1", game.KilledWraith1)); }
            if (game._KilledWraith2 != null) { gameEl.Add(new XAttribute("killedEnemy_wraith2", game.KilledWraith2)); }
            if (game._KilledYeti1 != null) { gameEl.Add(new XAttribute("killedEnemy_yeti1", game.KilledYeti1)); }
            if (game._KilledZombie1 != null) { gameEl.Add(new XAttribute("killedEnemy_zombie1", game.KilledZombie1)); }
            if (game._KilledZombieElectric1 != null) { gameEl.Add(new XAttribute("killedEnemy_zombie_electric1", game.KilledZombieElectric1)); }
            if (game._KilledZombieSnake1 != null) { gameEl.Add(new XAttribute("killedEnemy_zombie_snake1", game.KilledZombieSnake1)); }
            if (game._LatencyCalibrated != null) { gameEl.Add(new XAttribute("latencyCalibrated", game.LatencyCalibrated)); }
            if (game._LobbyMove != null) { gameEl.Add(new XAttribute("lobbyMove", game.LobbyMove)); }
            if (game._MentorLevelClear0 != null) { gameEl.Add(new XAttribute("mentorLevelClear0", game.MentorLevelClear0)); }
            if (game._MentorLevelClear1 != null) { gameEl.Add(new XAttribute("mentorLevelClear1", game.MentorLevelClear1)); }
            if (game._MentorLevelClear2 != null) { gameEl.Add(new XAttribute("mentorLevelClear2", game.MentorLevelClear2)); }
            if (game._MentorLevelClear3 != null) { gameEl.Add(new XAttribute("mentorLevelClear3", game.MentorLevelClear3)); }
            ...
            if (game._PreBossEffect != null) { gameEl.Add(new XAttribute("preBossEffect", game.PreBossEffect)); }
            if (game._ResolutionH != null) { gameEl.Add(new XAttribute("resolutionH", game.ResolutionH)); }
            if (game._ResolutionW != null) { gameEl.Add(new XAttribute("resolutionW", game.ResolutionW)); }
            if (game._ScreenShake != null) { gameEl.Add(new XAttribute("screenShake", game.ScreenShake)); }
            if (game._ShowDiscoFloor != null) { gameEl.Add(new XAttribute("showDiscoFloor", game.ShowDiscoFloor)); }
            if (game._ShowHudBeatBars != null) { gameEl.Add(new XAttribute("showHUDBeatBars", game.ShowHudBeatBars)); }
            if (game._ShowHudHeart != null) { gameEl.Add(new XAttribute("showHUDHeart", game.ShowHudHeart)); }
            if (game._ShowHints != null) { gameEl.Add(new XAttribute("showHints", game.ShowHints)); }
            if (game._ShowSpeedRunTimer != null) { gameEl.Add(new XAttribute("showSpeedrunTimer", game.ShowSpeedRunTimer)); }
            if (game._ShownNocturnaIntro != null) { gameEl.Add(new XAttribute("shownNocturnaIntro", game.ShownNocturnaIntro)); }
            if (game._ShownSeizureWarning != null) { gameEl.Add(new XAttribute("shownSeizureWarning", game.ShownSeizureWarning)); }
            ...
            if (game._UseChoral != null) { gameEl.Add(new XAttribute("useChoral", game.UseChoral)); }
